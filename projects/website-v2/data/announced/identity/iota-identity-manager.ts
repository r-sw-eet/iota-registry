...
export const iotaIdentityManager: AnnouncedEntry = {
  id: "iota-identity-manager",
  name: "IOTA Identity Manager",
  tier: "if",
  hackathons: [
    {
  ...
  description: "Sovereign identity management layer. MasterZ × IOTA Hackathon cohort participant.",
  stack: [],
