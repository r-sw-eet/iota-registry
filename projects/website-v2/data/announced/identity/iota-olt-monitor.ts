...
export const iotaOltMonitor: AnnouncedEntry = {
  id: "iota-olt-monitor",
  name: "IOTA OLT Monitor",
  tier: "if",
  hackathons: [
    {
  ...
  description: "Real-time infrastructure notarization. MasterZ × IOTA Hackathon cohort participant.",
  stack: [],
