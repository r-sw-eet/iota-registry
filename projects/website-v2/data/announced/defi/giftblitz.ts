...
export const giftblitz: AnnouncedEntry = {
  id: "giftblitz",
  name: "GiftBlitz",
  tier: "if",
  hackathons: [
    {
      ...
      result: "participant",
      date: "2026-02-26",
      note: "RWA & TradFi track cohort; did not reach top 5 finale."
    }
  ],
  onchain: "none",
  category: "DeFi",
  ...
  description: "Decentralized trustless gift card marketplace. MasterZ × IOTA Hackathon cohort participant.",
  stack: [],
